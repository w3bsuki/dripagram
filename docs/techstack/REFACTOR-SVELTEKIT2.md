...
<div class="flex min-h-screen items-center justify-center bg-gray-50">
	<div class="text-center">
		<h1 class="mb-4 text-6xl font-bold text-red-600">{$page.status}</h1>
		<h2 class="mb-6 text-2xl font-semibold text-gray-800">Oops! {message}</h2>
...
<div class="flex min-h-screen items-center justify-center bg-gray-50">
	<div class="w-full max-w-md text-center">
		<div class="rounded-lg bg-white p-8 shadow-lg">
			...
			<h1 class="mb-2 text-2xl font-bold text-gray-800">Authentication Error</h1>
			...
			<div class="space-y-3">
				<a
					href="/auth/login"
					class="block w-full rounded-lg bg-purple-600 px-4 py-2 text-white transition-colors hover:bg-purple-700"
				>
					Sign In
				</a>
				<a
					href="/"
					class="block w-full rounded-lg border border-gray-300 px-4 py-2 transition-colors hover:bg-gray-50"
				>
					Go Home
				</a>
			</div>
	...
	<div class="w-full max-w-lg text-center">
		<div class="rounded-lg bg-white p-8 shadow-lg">
			...
			<h1 class="mb-4 text-3xl font-bold text-gray-800">
				Product {$page.status === 404 ? 'Not Found' : 'Error'}
			</h1>
			<p class="mb-8 text-gray-600">
				{#if $page.status === 404}
			...
			<div class="space-y-3">
				<a
					href="/browse"
					class="block w-full rounded-lg bg-purple-600 px-6 py-3 text-white transition-colors hover:bg-purple-700"
				>
					Browse All Products
				</a>
				<a
					href="/"
					class="block w-full rounded-lg border border-gray-300 px-6 py-3 transition-colors hover:bg-gray-50"
				>
					Go Home
				</a>
			</div>
...
<div class="flex min-h-screen items-center justify-center bg-gray-50">
	<div class="w-full max-w-md text-center">
		<div class="rounded-lg bg-white p-8 shadow-lg">
			...
			<h1 class="mb-2 text-2xl font-bold text-gray-800">Shopping Error</h1>
			<p class="mb-6 text-gray-600">
...
<div class="animate-pulse p-6">
	...
	<div class="mb-4 h-64 rounded bg-gray-200"></div>
	<div class="space-y-2">
